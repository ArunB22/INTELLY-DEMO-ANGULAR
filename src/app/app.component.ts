  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit(): void {
    ...
    if (isPlatformBrowser(this.platformId)) {
      this.dataManager.user_email = this.localStorage.getItem(
        AppConstants.STORAGE_KEY_USER_EMAIL
      );
      this.dataManager.user_id = this.localStorage.getItem(
        AppConstants.STORAGE_KEY_USER_ID
      );
      this.dataManager.user_id
